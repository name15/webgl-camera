...
let fieldset = new GUI.CustomFieldset("Camera settings", cameraSettings, {
  ...
  fieldOfView: { min: 0, max: 180, format: (n: number) => n.toFixed(0) + "°" },
...
async function main() {
  // Shader program data
  let programSource: ShaderSource = {
