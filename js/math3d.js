...
(function (Math3D) {
    function multiplyPoint(matrix, point) {
        ...
        let c1r1 = matrix[0], c2r1 = matrix[1], c3r1 = matrix[2], c4r1 = matrix[3], c1r2 = matrix[4], c2r2 = matrix[5], c3r2 = matrix[6], c4r2 = matrix[7], c1r3 = matrix[8], c2r3 = matrix[9], c3r3 = matrix[10], c4r3 = matrix[11], c1r4 = matrix[12], c2r4 = matrix[13], c3r4 = matrix[14], c4r4 = matrix[15];
        return [
    ...
    Math3D.multiplyPoint = multiplyPoint;
    ...
    Math3D.multiplyMatrices = multiplyMatrices;
    ...
    Math3D.multiplyArrayOfMatrices = multiplyArrayOfMatrices;
    ...
    Math3D.identityMatrix = identityMatrix;
    ...
    Math3D.rotateXMatrix = rotateXMatrix;
    ...
    Math3D.rotateYMatrix = rotateYMatrix;
    ...
    Math3D.rotateZMatrix = rotateZMatrix;
    ...
    Math3D.translateMatrix = translateMatrix;
    ...
    Math3D.scaleMatrix = scaleMatrix;
    ...
    Math3D.perspectiveMatrix = perspectiveMatrix;
    ...
    Math3D.orthographicMatrix = orthographicMatrix;
    function sphericalToCartesian(r, lat, long) {
        return [
    ...
    Math3D.sphericalToCartesian = sphericalToCartesian;
})(Math3D || (Math3D = {}));
